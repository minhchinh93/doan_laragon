    ...
    <div class="col-md-12">
        <div class="content-panel">
            <h4><i class="fa fa-angle-right"></i> Manager User </h4><hr><table class="table table-striped table-advance table-hover">
                <button type="button" class="btn btn-theme02 left"><a style="color:white" href="{{ route('addCategory') }}" >thêm mới</a></button>
                <div class="row mt">
                    <div class="col-lg-4">
        ...
        <div class="col-lg-4">
            <div class="form-panel">
    <form action="{{ route('categoryaction') }}" class="form-inline col-lg-4 " role="form">
                ...
                <tr>
                    ...
                    <td>
                            <span class="btn btn-primary btn-xs">
                             ...
                             @if ( $show->deleted_at != null)
                             <span class="btn btn-primary btn-xs">
                             <a style="color:white" href="{{ route('restoreCategory',[$show->id]) }}">
                                  <i class="fa fa-trash-o "></i>
                               </a>
                            </span>
                            @endif
                            <span class="btn btn-danger btn-xs">
                                <a style="color:white" href="{{ route('deleteCategory',[$show->id]) }}"> <i class="fa fa-trash-o "></i></a>
                            </span>
