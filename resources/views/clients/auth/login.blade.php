...
<div class="container">
    ...
    <div id="content">
        ...
        <form action="{{ route('auth.login') }}" method="post" class="beta-form-checkout">
            @csrf
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <p class="inner-title">bạn quên mật khẩu ?<a href="{{ route('forgotpass') }}"><b> Lấy lại mât khâu !</b></a></p>
