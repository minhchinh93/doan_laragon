    ...
    <div class="container">
        ...
        <div class="pull-right">
            <div class="beta-breadcrumb font-large">
                <a href="{{ route('home') }}">Home</a> / <span>chi tiết giỏ hàng</span>
            </div>
        </div>
    ...
    <div id="content">
            ...
            <table class="shop_table beta-shopping-cart-table" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th class="product-remove">hoạt động</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr class="cart_item">
                            <td class="product-name">
                                <div class="media">
                                    <img class="pull-left" src="{{asset('/storage/images/'.$cart->options->image)}}" height="100px" alt="">
                            ...
                            <td class="product-subtotal">
                                <span class="amount">{{$cart->total}} vnd</span>
                            </td>

                            <td class="product-remove">
                                <a href="{{ route('deletecart',[$cart->rowId]) }}" class="remove" title="Remove this item"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
        ...
        <div class="cart-collaterals">
            ...
            <div class="cart-totals pull-right">
                ...
                <div class="cart-totals-row"><span>Order Total:</span><span>{{Cart::total()}} vnđ</span></div>
            </div>
